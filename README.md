...
A low token consumption Model Context Protocol (MCP) server for interacting with a local or remote SearXNG instance.
...
```sh
uv tool install git+https://github.com/jftlo/mcp_searxng
```
...
git clone https://github.com/jftlo/mcp_searxng.git
cd mcp_searxng
...
```sh
uvx --from git+https://github.com/jftlo/mcp_searxng mcp-searxng --server-url "https://your-instance"
```
